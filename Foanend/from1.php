...
<body background="../img/G4.jpg">
    <div class="container">
        ...
        <hr>
        <h1 class="mt-5 text-warning">categories</h1>
        <a href="insert1.php" class="btn btn-success">Go to Insert</a>
        <hr>
        <table id="mytable" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                include_once('../config/func1.php');
                $fetchdata = new DB_dog();
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><a href="update1.php?id=<?php echo $row['id']; ?>" class="btn btn-primary">Edit</a></td>
                        <td><a href="delete1.php?id=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a></td>
                    </tr>
